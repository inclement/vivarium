...
_DEPS = viv_types.h viv_server.h viv_workspace.h viv_layout.h viv_mappable_functions.h viv_view.h viv_output.h viv_cursor.h
...
_OBJ = vivarium.o viv_layout.o viv_workspace.o viv_server.o viv_mappable_functions.o viv_view.o viv_output.o viv_cursor.o
